         ...
         <div id="col-filters" class="col-12 col-sm-4 col-lg-3 pr-sm-0 pr-xl-2 mx-auto d-print-none">
            <div class="card mb-4">
               <div class="card-body p-0" id="filters">
                <form action="{{ route('vehicles.search') }}" method="GET" id="vehicle-filters" data-gtm-form-interact-id="0">
                    ...
                    @foreach($vehicles as $vehicle)
                        <div class="my-4 vehicle-row position-relative" id="vehicle-{{ $vehicle->id }}">
                            ...
                            <div class="d-md-flex border-bottom pb-4">
                                ...
                                $firstImage = !empty($images) ? $images[0] : 'default-vehicle-image.jpg';
                            ...
                            <div class="vehicle-image pr-3 d-none d-md-block d-xl-flex">
                                ...
                                <div class="w-100 flex-grow-1">
                                    <a name="lot-{{ $vehicle->id }}" class="w-100 photo-swipe show-vehicle-images d-inline-block" data-number="{{ $vehicle->id }}" data-hd="1">
                                        ...
                                        alt="{{ $vehicle->year }} {{ $vehicle->make ?? 'Unknown' }} {{ $vehicle->model ?? 'Vehicle' }} for sale"
                                        loading="lazy"
                                    ...
                                    <div class="position-relative">
                                        <a name="lot-{{ $vehicle->id }}" class="show-vehicle-images d-block" data-number="{{ $vehicle->id }}" data-hd="1">
                                            <div class="swiper vehicle-swiper swiper-initialized swiper-horizontal swiper-autoheight">
                                                ...
                                                @if($totalImages > 1)
                                                    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-1f5ed89fcb54bd71"></div>
                                                    <div class="swiper-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-1f5ed89fcb54bd71"></div>
                                                @endif
                    ...
                    .then(function (items) {
                        ...
                        try {
                            ...
                            gallery.listen('beforeChange', function() {
                                var captionElement = document.querySelector('.pswp__caption__center');
                                    if (captionElement) {
                                        captionElement.textContent = captionElement.textContent.replace(/\{.*?\}/g, '').trim();
                                    }
                                document.querySelectorAll('.current-image').forEach(el => {
